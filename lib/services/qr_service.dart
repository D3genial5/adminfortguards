  ...
  static Future<void> _marcarEntradaVerificada(QrInvitadoModel qr) async {
    try {
      ...
      if (query.docs.isNotEmpty) {
        ...
        AppLog.log('✅ Entrada verificada automáticamente para ${qr.invitadoNombre}', name: 'QrService');
        ...
        if (queryByCi.docs.isNotEmpty) {
          ...
          AppLog.log('✅ Entrada verificada por CI para ${qr.invitadoNombre}', name: 'QrService');
        }
      }
    } catch (e) {
      AppLog.log('⚠️ Error marcando entrada verificada: $e', name: 'QrService');
    }
  }
}
